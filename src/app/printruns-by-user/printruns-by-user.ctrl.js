module.exports = (function (angular) {
    ...
    return ['$scope', 'printrunsByUserFac', 'i18nFilter', '$timeout',
        function ($scope, printrunsByUserFac, i18nFilter, $timeout) {

            $scope.labels = Object.keys(i18nFilter("printruns-by-user.labels"));
            $scope.columns = i18nFilter("printruns-by-user.columns");
            ...
            $scope.exportXLS = function () {
                ...
                const fileName = `printrunsbyuser_${timestamp}.xlsx`;
            ...
            $scope.initGrid = function (s, e) {
                for (var i = 0; i < $scope.columns.length; i++) {
                    ...
                    col.header = i18nFilter("printruns-by-user.labels." + $scope.columns[i].binding.replace('_', '-'));
                    col.wordWrap = false;
            ...
            const getData = () => {
                ...
                $scope.loading = true;
                printrunsByUserFac.data(fromDate, toDate).then(function (promise) {
                    $scope.loading = false;
