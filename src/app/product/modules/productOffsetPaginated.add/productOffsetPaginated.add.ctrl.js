module.exports = (function (angular) {
    ...
    return ['$scope', 'productOffsetPaginatedAddFac', '$location', 'i18nFilter', '$stateParams',
        function ($scope, productOffsetPaginatedAddFac, $location, i18nFilter, $stateParams) {
            ...
            $scope.pr_componentsoptions = i18nFilter("productOffsetPaginated-add.fields.pr_componentsoptions");
            ...
            $scope.$on('$viewContentLoaded', function () {
                ...
                productOffsetPaginatedAddFac.getTariffCodes().then(function (promise) {
                    $scope.tc_idoptions = [];
                    const { data } = promise
