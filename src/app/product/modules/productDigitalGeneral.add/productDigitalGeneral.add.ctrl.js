module.exports = (function (angular) {
    ...
    return ['$scope', 'productDigitalGeneralAddFac', '$location', 'i18nFilter', '$stateParams',
        function ($scope, productDigitalGeneralAddFac, $location, i18nFilter, $stateParams) {
            ...
            $scope.pr_materialsizemeasureoptions = i18nFilter("productDigitalGeneral-add.fields.pr_materialsizemeasureoptions");
            $scope.pr_varnishoptions = i18nFilter("productDigitalGeneral-add.fields.pr_varnishoptions");
            $scope.pr_varnisfinishedoptions = i18nFilter("productDigitalGeneral-add.fields.pr_varnisfinishedoptions");
            $scope.pr_laminateoptions = i18nFilter("productDigitalGeneral-add.fields.pr_laminateoptions");
            $scope.pr_laminatefinishedoptions = i18nFilter("productDigitalGeneral-add.fields.pr_laminatefinishedoptions");
