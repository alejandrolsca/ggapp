module.exports = (function (angular) {
    ...
    return ['$scope', 'productStampsInkPadUpdateFac', '$location', 'i18nFilter', '$stateParams',
        function ($scope, productStampsInkPadUpdateFac, $location, i18nFilter, $stateParams) {
            $scope.fmData = {};
            ...
            $scope.onSubmit = function () {
                ...
                productStampsInkPadUpdateFac.update($scope.fmData).then(function (promise) {
            ...
            $scope.pr_statusoptions = i18nFilter("productStampsInkPad-update.fields.pr_statusoptions");
            ...
            $scope.$on('$viewContentLoaded', function () {
                ...
                $scope.loading = true;
                productStampsInkPadUpdateFac.data().then(function (promise) {
                ...
                productStampsInkPadUpdateFac.getClient().then(function (promise) {
                ...
                productStampsInkPadUpdateFac.getMaterials($scope.fmData.pr_process).then(function (promise) {
                ...
                productStampsInkPadUpdateFac.getTariffCodes().then(function (promise) {
                    $scope.tc_idoptions = [];
                    const { data } = promise
