module.exports = (function (angular) {
    ...
    return ['$scope', 'productSerigraphyRigidAddFac', '$location', 'i18nFilter', '$stateParams',
        function ($scope, productSerigraphyRigidAddFac, $location, i18nFilter, $stateParams) {
            ...
            $scope.pr_foldoptions = i18nFilter("productSerigraphyRigid-add.fields.pr_foldoptions");
            $scope.pr_drilloptions = i18nFilter("productSerigraphyRigid-add.fields.pr_drilloptions");
            ...
            $scope.$on('$viewContentLoaded', function () {
                ...
                productSerigraphyRigidAddFac.getInks($scope.fmData.pr_process).then(function (promise) {
                ...
                productSerigraphyRigidAddFac.getTariffCodes().then(function (promise) {
                    $scope.tc_idoptions = [];
                    const { data } = promise
