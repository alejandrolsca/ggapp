module.exports = (function (angular) {
    ...
    return ['$scope', 'productFlexoRibbonsUpdateFac', '$location', 'i18nFilter', '$stateParams',
        function ($scope, productFlexoRibbonsUpdateFac, $location, i18nFilter, $stateParams) {
            $scope.fmData = {
                "pr_process": "flexo",
                "pr_type": "ribbons",
                "pr_status": "A"
            ...
            $scope.onSubmit = function () {
                ...
                productFlexoRibbonsUpdateFac.update($scope.fmData).then(function (promise) {
            ...
            $scope.pr_statusoptions = i18nFilter("productFlexoRibbons-update.fields.pr_statusoptions");
            ...
            $scope.$on('$viewContentLoaded', function () {
                ...
                $scope.loading = true;
                productFlexoRibbonsUpdateFac.data().then(function (promise) {
                ...
                productFlexoRibbonsUpdateFac.getClient().then(function (promise) {
                ...
                productFlexoRibbonsUpdateFac.getMaterials($scope.fmData.pr_process).then(function (promise) {
                ...
                productFlexoRibbonsUpdateFac.getTariffCodes().then(function (promise) {
                    $scope.tc_idoptions = [];
                    const { data } = promise
