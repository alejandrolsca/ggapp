    ...
    return ['$scope', 'productFlexoLabelsAddFac', '$location', 'i18nFilter', '$stateParams',
        function ($scope, productFlexoLabelsAddFac, $location, i18nFilter, $stateParams) {
            ...
            $scope.onSubmit = function () {
                ...
                productFlexoLabelsAddFac.add($scope.fmData).then(function (promise) {
            ...
            $scope.pr_languageoptions = i18nFilter("productFlexoLabels-add.fields.pr_languageoptions");            
            ...
            $scope.pr_papersizemeasureoptions = i18nFilter("productFlexoLabels-add.fields.pr_papersizemeasureoptions");
            ...
            $scope.pr_laminatefinishedoptions = i18nFilter("productFlexoLabels-add.fields.pr_laminatefinishedoptions");
            $scope.pr_laminatecaliberoptions = i18nFilter("productFlexoLabels-add.fields.pr_laminatecaliberoptions");
            $scope.pr_foliooptions = i18nFilter("productFlexoLabels-add.fields.pr_foliooptions");
            $scope.pr_precutoptions = i18nFilter("productFlexoLabels-add.fields.pr_precutoptions");
            $scope.pr_coreoptions = i18nFilter("productFlexoLabels-add.fields.pr_coreoptions");
            $scope.pr_blocksoptions = i18nFilter("productFlexoLabels-add.fields.pr_blocksoptions");
            $scope.pr_statusoptions = i18nFilter("productFlexoLabels-add.fields.pr_statusoptions");
            ...
            $scope.$on('$viewContentLoaded', function () {
                ...
                productFlexoLabelsAddFac.getClient().then(function (promise) {
                    $scope.loading = false;
                ...
                productFlexoLabelsAddFac.getPapers().then(function (promise) {
                    if (angular.isArray(promise.data)) {
                        $scope.pa_idoptions = [];
                        angular.forEach(promise.data, function (value, key) {
