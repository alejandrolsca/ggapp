module.exports = (function (angular) {
    ...
    return ['$scope', 'productDiecuttingGeneralAddFac', '$location', 'i18nFilter', '$stateParams',
        function ($scope, productDiecuttingGeneralAddFac, $location, i18nFilter, $stateParams) {
            ...
            $scope.pr_diecuttingmeasureoptions = i18nFilter("productDiecuttingGeneral-add.fields.pr_diecuttingmeasureoptions");
            ...
            $scope.$on('$viewContentLoaded', function () {
                ...
                productDiecuttingGeneralAddFac.getTariffCodes().then(function (promise) {
                    $scope.tc_idoptions = [];
                    const { data } = promise
