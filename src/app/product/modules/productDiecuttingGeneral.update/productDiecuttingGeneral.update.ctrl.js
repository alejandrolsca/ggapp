module.exports = (function (angular) {
    ...
    return ['$scope', 'productDiecuttingGeneralUpdateFac', '$location', 'i18nFilter', '$stateParams',
        function ($scope, productDiecuttingGeneralUpdateFac, $location, i18nFilter, $stateParams) {
            $scope.fmData = {};
            ...
            $scope.pr_finalsizemeasureoptions = i18nFilter("productDiecuttingGeneral-update.fields.pr_finalsizemeasureoptions");
            $scope.pr_diecuttingmeasureoptions = i18nFilter("productDiecuttingGeneral-update.fields.pr_diecuttingmeasureoptions");
            $scope.pr_statusoptions = i18nFilter("productDiecuttingGeneral-update.fields.pr_statusoptions");
            ...
            $scope.$on('$viewContentLoaded', function () {
                ...
                $scope.loading = true;
                productDiecuttingGeneralUpdateFac.data().then(function (promise) {
                ...
                productDiecuttingGeneralUpdateFac.getClient().then(function (promise) {
                ...
                productDiecuttingGeneralUpdateFac.getMaterials($scope.fmData.pr_process).then(function (promise) {
                ...
                productDiecuttingGeneralUpdateFac.getTariffCodes().then(function (promise) {
                    $scope.tc_idoptions = [];
                    const { data } = promise
