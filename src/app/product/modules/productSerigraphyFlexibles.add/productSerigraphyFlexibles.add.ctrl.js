module.exports = (function (angular) {
    ...
    return ['$scope', 'productSerigraphyFlexiblesAddFac', '$location', 'i18nFilter', '$stateParams',
        function ($scope, productSerigraphyFlexiblesAddFac, $location, i18nFilter, $stateParams) {
            ...
            $scope.pr_drilloptions = i18nFilter("productSerigraphyFlexibles-add.fields.pr_drilloptions");            
            ...
            $scope.$on('$viewContentLoaded', function () {
                ...
                productSerigraphyFlexiblesAddFac.getInks($scope.fmData.pr_process).then(function (promise) {
                ...
                productSerigraphyFlexiblesAddFac.getMaterials($scope.fmData.pr_process).then(function (promise) {
                    if (angular.isArray(promise.data)) {
                        $scope.mt_idoptions = [];
                        angular.forEach(promise.data, function (value, key) {
                ...
                productSerigraphyFlexiblesAddFac.getTariffCodes().then(function (promise) {
                    $scope.tc_idoptions = [];
                    const { data } = promise
