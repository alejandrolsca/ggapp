module.exports = (function (angular) {
    ...
    return ['$scope', 'productPlotterBannerAddFac', '$location', 'i18nFilter', '$stateParams',
        function ($scope, productPlotterBannerAddFac, $location, i18nFilter, $stateParams) {
            ...
            $scope.pr_papersizemeasureoptions = i18nFilter("productPlotterBanner-add.fields.pr_papersizemeasureoptions");
            ...
            $scope.$on('$viewContentLoaded', function () {
                ...
                productPlotterBannerAddFac.getPapers().then(function (promise) {
                    if (angular.isArray(promise.data)) {
                        $scope.pa_idoptions = [];
                        angular.forEach(promise.data, function (value, key) {
