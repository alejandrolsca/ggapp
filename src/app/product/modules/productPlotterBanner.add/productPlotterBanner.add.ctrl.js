    ...
    return ['$scope', 'productPlotterBannerAddFac', '$location', 'i18nFilter', '$stateParams',
        function ($scope, productPlotterBannerAddFac, $location, i18nFilter, $stateParams) {
            ...
            $scope.$on('$viewContentLoaded', function () {
                ...
                productPlotterBannerAddFac.getInks($scope.fmData.pr_process).then(function (promise) {
                ...
                productPlotterBannerAddFac.getMaterials($scope.fmData.pr_process).then(function (promise) {
                    if (angular.isArray(promise.data)) {
                        $scope.mt_idoptions = [];
                        angular.forEach(promise.data, function (value, key) {
                ...
                productPlotterBannerAddFac.getTariffCodes().then(function (promise) {
                    $scope.tc_idoptions = [];
                    const { data } = promise
