module.exports = (function (angular) {
    ...
    return ['$scope', 'printrunsByUser2Fac', 'i18nFilter', '$timeout',
        function ($scope, printrunsByUser2Fac, i18nFilter, $timeout) {

            $scope.labels = Object.keys(i18nFilter("printruns-by-user2.labels"));
            $scope.columns = i18nFilter("printruns-by-user2.columns");
            ...
            $scope.exportXLS = function () {
                ...
                const fileName = `printrunsbyuser2_${timestamp}.xlsx`;
            ...
            $scope.initGrid = function (s, e) {
                for (var i = 0; i < $scope.columns.length; i++) {
                    ...
                    col.header = i18nFilter("printruns-by-user2.labels." + $scope.columns[i].binding.replace('_', '-'));
                    col.wordWrap = false;
            ...
            $scope.$on('$viewContentLoaded', function () {
                ...
                $scope.fromDate = new wijmo.input.InputDate('#fromDate', {
                    format: 'yyyy-MM-dd',
                    mask: '9999-99-99',
                    value: new Date(moment().startOf('day'))
                });
                ...
                $scope.toDate = new wijmo.input.InputDate('#toDate', {
                    ...
                    format: 'yyyy-MM-dd',
                    mask: '9999-99-99',
                    value: new Date(moment().endOf('day'))
                });
